    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_nascimento', models.CharField(default='01 de Janeiro de 1901', max_length=255, verbose_name='Data Nascimento')),
                ('email', models.EmailField(max_length=254, verbose_name='Email')),
                ('conhecimentos', models.TextField(max_length=255, verbose_name='Conhecimentos')),
                ('github', models.CharField(default='https://github.com/Seu_gitHub', max_length=100, verbose_name='Github')),
